 ...
 * @author User
 */
public class AuthorsEdit extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            request.setAttribute("author", facade.getAuthorById(new Integer(request.getParameter("id"))));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            facade.editAuthor(new Integer(request.getParameter("id")),
